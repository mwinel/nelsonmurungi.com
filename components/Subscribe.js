    ...
    <div className="border border-blue-200 rounded p-4 lg:p-8 my-4 w-full dark:border-gray-800 bg-blue-50 dark:bg-gray-700">
      ...
      <form className=" my-4 flex flex-col lg:flex-row justify-between">
        <input
          ...
          autoComplete="email"
          required
          className="px-4 py-2 focus:ring-blue-500 focus:border-blue-500 block w-full border-gray-300 rounded bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100"
        />
        <button
