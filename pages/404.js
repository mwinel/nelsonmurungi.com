...
const NotFound = () => {
  return (
    <>
      <Head>
        <title>Nelson Murungi | Not Found</title>
      </Head>
      <PageLayout>
        <div className="flex flex-col justify-center max-w-2xl md:p-0 mx-auto h-96 text-center lg:p-10">
          ...
          <p className="text-base my-10 text-gray-800 dark:text-gray-100">
            I am so sorry you could not find what you are looking for. You
            are definetely looking for something I did not think would be
            important to you. Once again I apologise, my bad.
          </p>
          <Link href="/">
